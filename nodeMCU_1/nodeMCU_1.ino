...
int sensores[cantidadSensores] = {D2, D1};
int id[cantidadSensores] = {1, 2};
bool estado[cantidadSensores];

int pulsadores[cantidadReles] = {D3, D4, D5};
bool presionado[cantidadReles];
int reles[cantidadReles] = {D6, D7, D8};
int id2[cantidadReles] = {8, 9, 10};
